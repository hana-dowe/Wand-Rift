...
namespace Unity.FPS.Gameplay
{
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        bool m_SecondaryFireInputWasHeld;
        ...
        void LateUpdate()
        {
            m_SecondaryFireInputWasHeld = GetSecondaryFireInputHeld();
            m_FireInputWasHeld = !m_SecondaryFireInputWasHeld && GetFireInputHeld();
        ...
        public bool GetFireInputReleased()
        {
         ...
         public bool GetSecondaryFireInputDown()
        {
            return GetSecondaryFireInputHeld() && !m_SecondaryFireInputWasHeld;
        }

        public bool GetSecondaryFireInputReleased()
        {
            return !GetSecondaryFireInputHeld() && m_SecondaryFireInputWasHeld;
        }
        ...
        public bool GetSecondaryFireInputHeld()
        {
            if (CanProcessInput())
            {
                bool isGamepad = Input.GetAxis(GameConstants.k_ButtonNameGamepadFire) != 0f;
                ...
                {
                    return Input.GetButton(GameConstants.k_ButtonNameSecondaryFire);
                }
            }
